      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Nivel</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Agregar Nivel ::</span>
                    <br />Torre: {$nomTorre}
                    <br />Proyecto: {$nomProy}                    
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-project-level.tpl"}
		</div>