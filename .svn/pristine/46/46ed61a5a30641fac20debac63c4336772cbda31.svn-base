      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Torre</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Agregar Torre ::</span>
                	<br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-project-item.tpl"}
		</div>