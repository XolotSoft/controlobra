      ...
      <div id="ftitl">
    		<div class="flabel">Detalles de Cancelaci&oacute;n Contrato No. {$info.contractId}</div>
				<div id="vtitl" style="padding-top:10px">                	
                    ...
                    <tr>
                        ...
                        <div align="center" style="color:#FFF">
                        	.:: Detalles Cancelaci&oacute;n Contrato No. {$info.noContract} ::.
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/view-cancel-contract.tpl"}
		</div>