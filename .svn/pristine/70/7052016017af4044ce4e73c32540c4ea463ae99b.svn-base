<div id="divForm">
    ...
    <fieldset>
        ...
        <a href="javascript:void(0)" onclick="cp.select(document.editTypeForm.color,'pick');return false;" id="pick" style="border: 1px solid #000000; font-family:Verdana; font-size:10px; text-decoration: none; background-color:{$info.color}">&nbsp;&nbsp;&nbsp;</a>
      ...
      <div style="clear:both"></div>
        ...
        <input type="hidden" id="id" name="id" value="{$info.projTypeId}" />
  	</fieldset>
	</form>
</div>