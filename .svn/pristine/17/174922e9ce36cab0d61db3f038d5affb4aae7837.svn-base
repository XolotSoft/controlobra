      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Agregar Area ::</span>
                    <br />Nivel: {$nomNivel}
                    <br />Torre: {$nomTorre}
                    <br />Proyecto: {$nomProy}                    
                </div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-project-depto.tpl"}
		</div>