<div id="divForm">
	<form id="addTypeForm" name="addTypeForm" method="post">
    <fieldset>        
        ...
        <a href="javascript:void(0)" onclick="cp.select(document.addTypeForm.color,'pick');return false;" id="pick" style="border: 1px solid #000000; font-family:Verdana; font-size:10px; text-decoration: none; background-color:#FFFFFF">&nbsp;&nbsp;&nbsp;</a>
      ...
      <div style="clear:both"></div>
        ...
        <div class="formLine" style="text-align:center; margin-left:300px">            
            <a class="button_grey" id="btnAddType"><span>Agregar</span></a>           
     	</div> 
        <input type="hidden" id="type" name="type" value="saveAddType"/>
