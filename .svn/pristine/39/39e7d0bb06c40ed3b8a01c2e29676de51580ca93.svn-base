<div id="divForm">
        ...
        {include file="{$DOC_ROOT}/templates/lists/enumProjLevelsReqAceroView.tpl"}
        ...
        <tr>
        	<td>{$info.totalRango|number_format:2:".":","}</td>
            <td>{$info.requiActual|number_format:2:".":","}</td>
            <td>{$info.saldoRango|number_format:2:".":","}</td>
        </tr>
        <tr><td colspan="3">&nbsp;</td>
        <tr>
        ...
        <tr>
        	<td>{$info.totalConcept|number_format:2:".":","}</td>
            <td>&nbsp;</td>
            <td>{$info.saldoConcept|number_format:2:".":","}</td>
        </tr>
        ...
        <tr>
        	<td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>{$info.totalReq|number_format:2:".":","}</td>
        </tr>
        </table> 
