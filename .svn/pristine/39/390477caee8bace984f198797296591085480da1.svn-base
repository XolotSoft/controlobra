      ...
      <div id="ftitl">
    		<div class="flabel">Editar Contrase&ntilde;a</div>
				<div id="vtitl"><span title="Titulo">Editar Contrase&ntilde;a</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-personal-passwd.tpl"}
		</div>