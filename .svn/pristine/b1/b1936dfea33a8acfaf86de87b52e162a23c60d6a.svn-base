...
function AddCategoryDiv(id)
{
	...
	new Ajax.Request(WEB_ROOT+'/ajax/material-category.php', 
	{
		method:'post',
...
function AddSubcategoryDiv(id)
{
	...
	new Ajax.Request(WEB_ROOT+'/ajax/material-subcategory.php', 
	{
		method:'post',
		parameters: {type: "addSubcategory", matCatId:id},
    onSuccess: function(transport){
			var response = transport.responseText || "no response text";
			FViewOffSet(response);
...
function AddConceptDiv(id)
{
	...
	new Ajax.Request(WEB_ROOT+'/ajax/material-concept.php', 
	{
		method:'post',
		parameters: {type: "addConcept", matSubcatId:id},
    onSuccess: function(transport){
			var response = transport.responseText || "no response text";
