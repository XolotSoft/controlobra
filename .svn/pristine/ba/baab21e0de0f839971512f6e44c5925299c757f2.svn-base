      ...
      <div id="ftitl">
    		<div class="flabel">Informaci&oacute;n de Entrega de Material <br /> Proyecto :: {$info.name}</div>
				<div id="vtitl"><span title="Titulo">Informaci&oacute;n de Entrega de Material <br /> Proyecto :: {$info.name}</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-address.tpl"}
		</div>