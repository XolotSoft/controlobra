      ...
      <div id="ftitl">
    		<div class="flabel">Editar SubTipo de Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:210px">:: Editar SubTipo de Area ::</span>
                	<br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-subtype.tpl"}
		</div>