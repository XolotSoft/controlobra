...
<head>
    ...
    <link href="{$WEB_ROOT}/assets/frameworks/bootstrap3/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="{$WEB_ROOT}/assets/css/registro.css" rel="stylesheet" type="text/css"/>
    <link href="{$WEB_ROOT}/assets/libraries/sweetalert/dist/sweetalert.css" rel="stylesheet" type="text/css"/>
    <script src="{$WEB_ROOT}/assets/libraries/sweetalert/dist/sweetalert.min.js"></script>
    <script src="{$WEB_ROOT}/javascript/functions.js"></script>
    <script src="{$WEB_ROOT}/assets/libraries/jquery2/jquery-2.2.0.min.js"></script>
    <script src="{$WEB_ROOT}/assets/frameworks/bootstrap3/js/bootstrap.min.js"></script>
</head>
<body>
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{$WEB_ROOT}/login" style="color:#000"><span style="color:#8A898E;" class="glyphicon glyphicon-home" aria-hidden="true"></span> Control de obra</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">  
                <li>
                    <a href="{$WEB_ROOT}/login" style="padding-right:30px;">
        ...
        <div class="panel panel-default" style="margin-bottom: 0px;">
              <div class="panel-footer">
                  <div class="container">
                    ...
                    <div class="row">
                    <hr class="hr-footer">
                        <a href="http://www.avantika.com.mx" style="text-decoration:none;" target="_blank">powered by <b>AVANTIKA </b><img src="{$WEB_ROOT}/images/logoavantika.png" alt="" style="height:22px;"></a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <script src="{$WEB_ROOT}/javascript/registro.js"></script>
</body>
</html>