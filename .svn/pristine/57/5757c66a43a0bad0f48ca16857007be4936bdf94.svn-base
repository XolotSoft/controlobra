      ...
      <div id="ftitl">
    		<div class="flabel">Detalles Pedidos Req. No.</div>
				<div id="vtitl" style="padding-top:10px">                	
                    ...
                    <tr>
                        ...
                        <div align="center" style="color:#FFF">
                        	.:: Detalles Pedidos Requisici&oacute;n No. {$info.requisicionId} ::.
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/view-req-pedidos.tpl"}
		</div>