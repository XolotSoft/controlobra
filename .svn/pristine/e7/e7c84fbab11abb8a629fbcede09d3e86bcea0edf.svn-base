      ...
      <div id="ftitl">
    		<div class="flabel">Editar Direcci&oacute;n</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Editar Direcci&oacute;n ::</span>
                	<br />
                    Cliente: {$nomCust}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-customer-address.tpl"}
		</div>