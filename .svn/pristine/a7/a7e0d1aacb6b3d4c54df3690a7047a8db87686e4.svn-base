      ...
      <div id="ftitl">
    		<div class="flabel">Agregar SubTipo de Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:210px">:: Agregar SubTipo de Area ::</span>
                    <br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-project-subtype.tpl"}
		</div>