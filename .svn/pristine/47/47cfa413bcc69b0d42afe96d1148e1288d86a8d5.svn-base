<div id="divForm">
    ...
    <fieldset>
        ...
        <div id="listSuppliers" style="width:320px; float:left">
        	{include file="{$DOC_ROOT}/templates/lists/enumSupEst.tpl"}
        </div>
        <div style="float:left; display:none" id="supPrice">
        	<div style="float:left">Precio:&nbsp;</div>
            <div style="float:left"><input type="text" name="cPrice" id="cPrice" class="smallInput" style="width:100px" /></div>
        </div>
        <hr />
        ...
        <tr>
        	<td style="border:0px" width="200" valign="top">
                <div id="listTypeAreas">{include file="{$DOC_ROOT}/templates/lists/enumProjType3.tpl"}</div>   
            </td>
            <td style="border:0px" width="160" valign="top"></td>            
        </tr>
        </table>  
        ...
        {include file="{$DOC_ROOT}/templates/lists/enumProjItem2.tpl"}</div>
        <hr />      
        
        <div id="enumLevels">        
        {include file="{$DOC_ROOT}/templates/lists/enumProjLevelsEst.tpl"}
        </div>
        ...
        <tr>
        	<td><input type="text" name="retencion" id="retencion" class="smallInput" style="width:60px" value="0" onblur="UpdateTotales()" /></td>
            <td>&nbsp;</td>
