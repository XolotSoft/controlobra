<div class="grid_16" id="content">
  ...
  <div class="grid_9">
  <h1 class="resumenes">Estado de Cuenta de Clientes</h1>
  </div>
  {*
  ...
  *}
  ...
  <div class="portlet">
      ...
      <div class="portlet-content nopadding" id="contenido">
        ...
        <tr>
            ...
            <tbody>     
                ...
                <tr><td height="10"></td></tr>
                <tr>    	
                    <td bgcolor="#D8D8D8" class="txtBlack" height="40">&nbsp;UNIDAD</td>
                    <td bgcolor="#D8D8D8" class="txtBlack" align="right">{$info.depto} {$info.item}&nbsp;</td>
                </tr>
                <tr><td height="10"></td></tr>
            </tbody>
            </table>
            ...
            <tbody> 
                <tr>    	
                    <td bgcolor="" class="txtBlack" height="40">&nbsp;AREA</td>
                    <td bgcolor="" class="txtBlack" align="right">{$info.m2Depto|number_format:2:'.':','} m2&nbsp;</td>
                </tr>
                <tr>    	
                    <td bgcolor="" class="txtBlack" height="40">&nbsp;TERRAZA</td>
                    <td bgcolor="" class="txtBlack" align="right">{$info.noTerrazas|number_format:2:'.':','} m2&nbsp;</td>
                </tr>
                <tr>    	
                    <td bgcolor="" class="txtBlack" height="40">&nbsp;JARDIN</td>
                    <td bgcolor="" class="txtBlack" align="right">{$info.jardines|number_format:2:'.':','} m2&nbsp;</td>
                </tr>
            </tbody>     
            </table>
            ...
            <tbody> 
                <tr>    	
                    <td bgcolor="" class="txtBlack" height="40">&nbsp;MANTENIMIENTO</td>
                    <td bgcolor="" class="txtBlack" align="right">{$info.mantenimiento|number_format:2:'.':','}&nbsp;</td>
                </tr>                
            </tbody>     
            </table>
      		</td>
            ...
            <td width="33%" valign="top">
			    ...
			    <table width="100%" cellpadding="0" cellspacing="0" id="tblMain" border="1" style="width:350px">
                    <tr>    	
                        <td class="txtBlack" height="40">&nbsp;COSTO m2</td>
                        <td class="txtBlack" align="right">{$info.priceM2|number_format:2:'.':','}&nbsp;</td>
                    </tr>                    
                </table>
                <div style="height:9px"></div>
			    <table width="100%" cellpadding="0" cellspacing="0" id="_tblMain" border="1" style="width:350px">
                    <tr>    	
                        <td class="txtBlack" width="90" height="35">&nbsp;CAJONES</td>
                        <td class="txtBlack" width="90" align="center">{$info.noCajones}</td>
                        <td class="txtBlack" align="left">{if $info.noCajones}No. {$info.cajones}{/if}</td>
                    </tr>
                    <tr>    	
                        <td class="txtBlack" height="35">&nbsp;BODEGAS</td>
                        <td class="txtBlack" align="center">{$info.noBodegas}</td>
                        <td class="txtBlack" align="left">{if $info.noBodegas}No. {$info.bodegas}{/if}</td>
                    </tr>                    
                </table>
                <div style="height:10px"></div>
                <table width="100%" cellpadding="0" cellspacing="0" id="tblMain" border="1" style="width:350px;">
                <tbody> 
                    <tr>    	
                        <td bgcolor="" class="txtBlack" height="40">&nbsp;EQUIPAMIENTO</td>
                        <td bgcolor="" class="txtBlack" align="right">{$info.equipamiento|number_format:2:'.':','}&nbsp;</td>
                    </tr>                
                </tbody>     
                </table>               
            </td>
      ...
      <tr>
      		<td width="100" align="left" height="30">&nbsp; SALDO DOCUMENTOS EXTRAORDINARIOS</td>
            <td width="100" align="right">${$info.saldoExtra|number_format:2:'.':','} &nbsp;</td>
      </tr>
      </table>
      ...
      <tr>
            ...
            <td bgcolor="#D8D8D8" align="right" {if $item.vencido}class="txtRojo2{/if}">${$item.saldoDep|number_format:2:'.':','} &nbsp;</td>
      </tr>
      {/foreach}      
      <tr>
      		<td height="30"></td>
...
<div align="center"><a href="{$WEB_ROOT}/resumen-contract"> << Regresar </a></div>
