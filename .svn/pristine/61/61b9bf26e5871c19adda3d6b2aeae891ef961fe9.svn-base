      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Direcci&oacute;n</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Agregar Direcci&oacute;n ::</span>
                	<br />
                    Cliente: {$nomCust}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-customer-address.tpl"}
		</div>