      ...
      <div id="ftitl">
    		<div class="flabel">Editar Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Editar Area ::</span>
                    <br />Nivel: {$nomNivel}
                    <br />Torre: {$nomTorre}
                    <br />Proyecto: {$nomProy}
                </div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-depto.tpl"}
		</div>