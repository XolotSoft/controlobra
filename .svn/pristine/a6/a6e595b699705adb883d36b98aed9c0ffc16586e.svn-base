      ...
      <div id="ftitl">
    		<div class="flabel">Editar Fecha de Entrega</div>
				<div id="vtitl"><span title="Titulo">Editar Fecha de Entrega</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-order-buy-fechaEnt.tpl"}
		</div>