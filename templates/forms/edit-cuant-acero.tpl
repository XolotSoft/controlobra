<div id="divForm">
    ...
    <fieldset>
        ...
        <tr>
            ...
            <input type="text" name="qtyConcept" id="qtyConcept" class="smallInput" style="width:50px" value="{$info.qtyConcept}" onchange="LoadEjesAcero()" />
            </div>
            </td>
        </tr>
        </table> 
        ...
        <tr>
        	<td>
            <div id="txtSubtotal">{$info.subtotal}</div>
      ...
      <div style="clear:both"></div>
        ...
        <div class="formLine" style="text-align:center; margin-left:300px">            
            <a class="button_grey" id="btnEditCuantAcero"><span>Actualizar</span></a>           
     	</div>
