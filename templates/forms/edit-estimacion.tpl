<div id="divForm">
	<form id="editEstimacionForm" name="editEstimacionForm" method="post">
    <fieldset>
      ...
      <div style="clear:both"></div>
        ...
        <div class="formLine" style="text-align:center; margin-left:300px">            
            <a class="button_grey" id="btnEditEstimacion"><span>Actualizar</span></a>           
     	</div> 
        <input type="hidden" id="type" name="type" value="saveEditEstimacion"/>
        <input type="hidden" id="id" name="id" value="{$info.estimacionId}" />
  	</fieldset>
	</form>
</div>