<div id="divForm">
    ...
    <fieldset>        
        ...
        <input class="smallInput small" name="noCat" id="noCat" type="text" size="50"/>
        <hr />
      ...
      <div style="clear:both"></div>
        ...
        <div class="formLine" style="text-align:center; margin-left:300px">            
            <a class="button_grey" id="btnAddCategory"><span>Agregar</span></a>           
     	</div> 
        <input type="hidden" id="type" name="type" value="saveAddCategory"/>       
  	</fieldset>
	</form>
</div>
