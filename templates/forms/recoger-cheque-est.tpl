<div id="divForm">
	<form id="recogerChequeForm" name="recogerChequeForm" method="post">
    <fieldset>        
        ...
        <div style="width:30%;float:left">Nombre de la Persona:</div>
        <input class="smallInput medium" name="nombre" id="nombre" type="text" size="50"/>
        <hr />
      ...
      <div style="clear:both"></div>
        ...
        <div class="formLine" style="text-align:center; margin-left:300px">            
            <a class="button_grey" id="btnRecogerCheque"><span>Agregar</span></a>           
     	</div> 
        <input type="hidden" id="type" name="type" value="saveRecogerCheque"/>
