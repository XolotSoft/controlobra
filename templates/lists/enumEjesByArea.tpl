...
<tr>
    <td style="border:0px" width="100">       
        ...
        <option value="{$item.projEjeLId}" {if $info.projEjeLId == $item.projEjeLId}selected{/if}>{$item.letra|replace:"1":"'"}</option>
        {/foreach}
        </select>
    </td>
    ...
    <td style="border:0px" width="100">
        ...
        <option value="{$item.projEjeNId}" {if $info.projEjeNId == $item.projEjeNId}selected{/if}>{$item.numero|replace:"A":"'"}</option>
        {/foreach}
        </select>
    </td>
    <td style="border:0px" align="center" width="10"> - </td>
