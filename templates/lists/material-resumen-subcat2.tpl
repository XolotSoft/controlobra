...
<tr id="conc_{$item.projectId}_{$itS.subcategoryId}">
    <td colspan="8" bgcolor="#FFFFFF" class="colB">
    	{include file="{$DOC_ROOT}/templates/lists/material-resumen-concept2.tpl"}
    </td>
</tr>
...
<tr>
    ...
    <td width="76" class="colR" align="center">{$itS.cantidad}</td>
    <td width="56" class="colR"></td>    
</tr>

<tr id="conc_{$item.projectId}_{777+$kS}">
    <td colspan="8" bgcolor="#FFFFFF" class="colB">
    	{include file="{$DOC_ROOT}/templates/lists/material-resumen-concept2.tpl" b="2"}
    </td>
</tr>
