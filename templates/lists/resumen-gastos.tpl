...
<tbody>     
    <tr>
        ...
        <td align="center" width="312" bgcolor="#EBEBEB" style="color:#000000">GASTO PRESUPUESTADO</td>
        <td width="51"></td>
        <td align="center" width="280" bgcolor="#EBEBEB" style="color:#000000">GASTO EN OBRA</td>
        <td width="51"></td>
        <td align="center" width="280" bgcolor="#EBEBEB" style="color:#000000">POR GASTAR</td>
    </tr>
</tbody>     
</table>
<table width="100%" cellpadding="0" cellspacing="0" id="tblMain" border="1" class="boxTable">
