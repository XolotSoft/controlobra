      ...
      <div id="ftitl">
    		<div class="flabel">Editar Nivel</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Editar Nivel ::</span>
                    <br />Torre: {$nomTorre}
                    <br />Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-level.tpl"}
		</div>