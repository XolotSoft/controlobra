      ...
      <div id="ftitl">
    		<div class="flabel">Detalles Estimaci&oacute;n</div>
				<div id="vtitl" style="padding-top:10px">                	
                    ...
                    <tr>
                        ...
                        <div align="center" style="color:#FFF">
                        	.:: Detallles Estimaci&oacute;n  No. {$info.estimacionId} ::.
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/view-estimacion.tpl"}
		</div>