      ...
      <div id="ftitl">
    		<div class="flabel">Editar Tipo de Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:210px">:: Editar Tipo de Area ::</span>
                	<br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-type.tpl"}
		</div>