      ...
      <div id="ftitl">
    		<div class="flabel">Editar Torre</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:250px">:: Editar Torre ::</span>
                	<br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-project-item.tpl"}
		</div>