      ...
      <div id="ftitl">
    		<div class="flabel">Editar Subpartida</div>
				<div id="vtitl"><span title="Titulo">Editar Subpartida</span></div>
                <br />
            	Partida: {$nomCat}
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-subcategory.tpl"}
		</div>