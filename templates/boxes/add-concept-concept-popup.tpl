      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Concepto</div>
				<div id="vtitl"><span title="Titulo">Agregar Concepto</span></div>
                <br />
            	Partida: {$nomCat} <br />
                Subpartida: {$nomSubcat}
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-concept-concept.tpl"}
		</div>