      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Tipo de Area</div>
				<div id="vtitl">
                	<span title="Titulo" style="padding-left:210px">:: Agregar Tipo de Area ::</span>
                    <br />
                    Proyecto: {$nomProy}
                </div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-project-type.tpl"}
		</div>