      ...
      <div id="ftitl">
    		<div class="flabel">Pedidos Requisici&oacute;n No.</div>
				<div id="vtitl" style="padding-top:10px">                	
                    ...
                    <tr>
                        ...
                        <div align="center" style="color:#FFF">
                        	.:: Pedidos Requisici&oacute;n No. {$info.requisicionId} ::.
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-req-pedidos.tpl"}
		</div>