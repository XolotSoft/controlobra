      ...
      <div id="ftitl">
    		<div class="flabel">Editar Orden de Compra No. {$info.orderBuyId}</div>
				<div id="vtitl"><span title="Titulo">Editar Orden de Compra No. {$info.orderBuyId}</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-order-buy.tpl"}
		</div>