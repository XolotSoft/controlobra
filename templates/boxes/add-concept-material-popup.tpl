      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Material</div>
				<div id="vtitl"><span title="Titulo">Agregar Material</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-concept-material.tpl"}
		</div>