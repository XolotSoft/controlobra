      ...
      <div id="ftitl">
    		<div class="flabel">Editar Concepto</div>
				<div id="vtitl"><span title="Titulo">Editar Concepto</span></div>
                <br />
            	Partida: {$nomCat} <br />
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-concept-concept.tpl"}
		</div>