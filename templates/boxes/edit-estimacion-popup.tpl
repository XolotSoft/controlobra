      ...
      <div id="ftitl">
    		<div class="flabel">Editar Cuantificaci&oacute;n</div>
				<div id="vtitl"><span title="Titulo">Editar Cuantificaci&oacute;n</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/edit-estimacion.tpl"}
		</div>