function RecogerChequeDiv(id)
{
	...
	new Ajax.Request(WEB_ROOT+'/ajax/estimacion-cheques.php', 
	{
		method:'post',
		parameters: {type: "recogerCheque", estimacionPagoId:id},
...
function CancelarChequeDiv(id)
{
	...
	{
		method:'post',
		parameters: {type: "cancelarCheque", estimacionPagoId:id},
    onSuccess: function(transport){
			var response = transport.responseText || "no response text";
			FViewOffSet(response);
...
function CobrarChequeDiv(id)
{
	...
	{
		method:'post',
		parameters: {type: "cobrarCheque", estimacionPagoId:id},
    onSuccess: function(transport){
			var response = transport.responseText || "no response text";
			FViewOffSet(response);
