...
{	
    ...
    onSuccess: function(transport){
			...
			{
				window.location.href = WEB_ROOT +  "project-new/step/2";			
			}
			else
			{
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT +  "project-new/step/3";
			}
			else
			{
				ShowStatusPopUp(splitResponse[1]);
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT +  "project-new/step/4";
			}
			else
			{
				ShowStatusPopUp(splitResponse[1]);
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT +  "project-new/step/5";				
			}
			else
			{
				ShowStatusPopUp(splitResponse[1]);
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT +  "project-new/step/6";				
			}
			else
			{
				ShowStatusPopUp(splitResponse[1]);
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT + "project-new/step/7";
			}
			else
			{
				ShowStatusPopUp(splitResponse[1]);
...
{	
    ...
    onSuccess: function(transport){
			...
			if(splitResponse[0] == "ok")
			{
				window.location.href = WEB_ROOT +  "project-new/step/8";
...
function GoStep(no)
{
	window.location.href = WEB_ROOT +  "project-new/step/" + no;
}
